...
exports.uploadEvent = async (req,res,next) =>{
    try {
        const {title, description, addedAt,host, campus, ticketPrice, venue, time, date} = req.body;
        ...
        const event = await new Event({
            title, description,campus,ticketPrice, host, venue,addedAt,time, data: urls,addedAt: Date.now(), date
        }).save();
