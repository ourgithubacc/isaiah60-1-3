...
const {addNews, getAllNews, getNews, getSliderNews, getNewsByCategory, deleteNews, updateNews, getIperuCampusNews, getMainCampusNews, deleteAllIperuNews, deleteAllMainNews, deleteAllNews} = require ('../controllers/news')
...
router.route('/deleteAllMainNews').delete(deleteAllMainNews)
router.route('/deleteAllIperuNews').delete(deleteAllIperuNews)
router.route('/deleteAllNews').delete(deleteAllNews)
