...
const {uploadEvent, getAllEvents, getEventByTitle, getEventsByHost, deleteEvent, updateEvent, getIperuCampusEvents, getMainCampusEvent, deleteAll, deleteAllIperuCampusEvent, deleteAllMainCampusEvent} = require('../controllers/event')
...
router.route('/deleteAllMainCampusEvent').delete(deleteAllMainCampusEvent)
router.route('/deleteAllIperuCampusEvent').delete(deleteAllIperuCampusEvent)
